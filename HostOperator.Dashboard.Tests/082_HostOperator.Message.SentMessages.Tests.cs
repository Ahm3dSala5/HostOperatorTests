...
namespace HostOperator.Tests
{
    public class HostOperatorMessageSentMessagesTests : IDisposable
    {
        ...
        [Test]
        public void SentMessagePage_TestMesssageOption()
        {
        ...
        [Test]
        public void SentMessagePage_TestSentMessageOption()
        {
            // to click on Messages option 
            SentMessagePage_TestMesssageOption();
            // to click on Sent Message option
            ...
            var SentMessageURL = "http://ec2-34-226-24-71.compute-1.amazonaws.com/App/Messages/Sent";
            Assert.AreEqual(SentMessageOption.GetAttribute("href"), $"{SentMessageURL}");
            Assert.AreEqual(SentMessageOption.GetAttribute("target"), "_self");
            Assert.IsTrue(SentMessageOption.Enabled);
            SentMessageOption.Click();
        }
        ...
        [Test]
        public void SentMessagePage_TableBarTest()
        {
        ...
        [Test]
        public void SentMessagePage_LogoutBtnTest()
        {
            // to open sent message page
            SentMessagePage_OpenPage();
        ...
        [Test]
        public void SentMessagePage_NotificationTest()
        {
            // to open sent message page
            SentMessagePage_OpenPage();
        ...
        [Test]
        public void SentMessagePage_TestPageTitle()
        {
            // to open sent message page
            SentMessagePage_OpenPage();
            ...
            Assert.AreEqual(title.Text, "Sent Messages");
            Assert.IsTrue(title.Displayed);
            Assert.IsTrue(title.Enabled);
        }

        [Test]
        public void SentMessagePage_DashboardBtnTest()
        {
            // to open sent message page
            SentMessagePage_OpenPage();
        ...
        public void SentMessagePage_SentMessagesBtnTest()
        {
            ...
            Assert.AreEqual(sentMessageBtn.Text, "Sent Messages");
        ...
        [Test]
        public void SentMessagePage_MessageTableTest()
        {
            // to open sent message page
            SentMessagePage_OpenPage();
